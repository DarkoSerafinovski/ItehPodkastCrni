 ...
 class UserController extends Controller
 {
    ...
    public function destroy($userId)
    {
        try {
            ...
            foreach ($user->mojiPodkasti as $podcast) {
                // Proveri da li je korisnik jedini autor podkasta
    ...
    public function getUsersOfFavoritesPodcasts()
    {
        try {
            ...
            // Dohvati omiljene podkaste korisnika
            ...
            // Skupljanje svih autora (unique) sa omiljenih podkasta
            $autori = $omiljeniPodkasti
                ->pluck('autori') // Dohvata kolekciju autora iz svakog podkasta
                ->flatten() // Spaja sve kolekcije u jednu ravnu kolekciju
                ->unique('id') // Uklanja duplikate autora po ID-u
                ->values(); // Resetuje ključeve kolekcije
